...
adv-experimental = Experimentele engines & opties
adv-experimental-hint = Toont laboratoriumzoekmethoden en afstelknoppen (PUCT, macro's, neurale kenmerkruimte). Standaard uit.
