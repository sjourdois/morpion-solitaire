...
adv-experimental = Moteurs et options expérimentaux
adv-experimental-hint = Révèle les méthodes de recherche et réglages de laboratoire (PUCT, macros, espace de caractéristiques neuronal). Désactivé par défaut.
