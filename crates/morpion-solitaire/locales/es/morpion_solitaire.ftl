...
opt-feat-adapt = NRPA espacio-features
...
adv-experimental = Motores y opciones experimentales
adv-experimental-hint = Muestra métodos de búsqueda y ajustes de laboratorio (PUCT, macros, espacio de características neuronal). Desactivado por defecto.
